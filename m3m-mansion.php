...
<body>
    ...
    <div style="display: inline-block; width: 100%; max-width: 1250px;">
        <img src="images/extra/M3M-Mansion-Gurgaon-image-2-.webp" alt="Image"
    ...
    <div class="container" >
        <div class="row align-items-center"> 
            <!-- Left Column: Content -->
            <div class="col-md-6">
            <h2>About M3M Mansion Sector 113 Gurgaon</h2>
<p><strong>M3M Mansion</strong>, located in the prestigious <strong>Sector 113, Gurgaon</strong>, is a luxurious residential development crafted to international standards. Strategically positioned along the <strong>Dwarka Expressway</strong>, this premium property beautifully blends grand architectural design with cutting-edge amenities, offering a lifestyle that’s both vibrant and sophisticated.</p>
<p>This iconic development is tailored for discerning homeowners seeking elegance, comfort, and a refined living experience. From world-class fixtures to thoughtfully designed layouts, every aspect of M3M Mansion radiates luxury.</p>
<p>In a city like Gurgaon—where residential demand is constantly rising due to expanding infrastructure and seamless connectivity to Delhi—<strong>M3M Mansion stands out</strong> with its modern homes, landscaped greens, and top-notch facilities including a <strong>clubhouse, swimming pool, gym, and curated garden spaces</strong>.</p>
<p>More than just a residence, <strong>M3M Mansion</strong> offers a lifestyle—ideal for both families and working professionals. With easy access to <strong>business hubs, reputed schools, hospitals, and recreational zones</strong>, this project ensures comfort and convenience at every step.</p>
<p>Whether for personal living or investment, <strong>M3M Mansion Sector 113</strong> sets a new benchmark for urban luxury living in Gurgaon, making it a truly remarkable address to call home.</p>
    ...
    <img src="images/extra/M3M-Mansion-Gurgaon-image.webp" alt="Project Features" 
...
<ul style="list-style: none; padding-left: 0; font-size: 15px;">
    <li>⛳ <strong>9+9 Holes Chip and Putt Golfing Scape Spread over 1.25 acres</strong></li>
    <li>🌳 <strong>7.5 acres of Central Vistas</strong></li>
    <li>💧 <strong>Rejuvenating Aquatic Serenity</strong></li>
    <li>🪟 <strong>Elegant Deck Space with Unobstructed Views</strong></li>
    <li>🌅 <strong>Large Wrap-Around Balconies</strong></li>
    <li>📱 <strong>Smart Home Automation System</strong></li>
    <li>🏊 <strong>Grand Outdoor Swimming Pool</strong></li>
    <li>🔥 <strong>Temperature-Regulated Terrace Pool</strong></li>
    <li>🪑 <strong>Shaded Benches and Gazebos for Sitting</strong></li>
    <li>🚪 <strong>Grand Entrance with Water Features</strong></li>
    <li>🚗 <strong>Wide Entry & Exit Gates with Boom Barriers</strong></li>
    <li>⛲ <strong>Central Water Fountains</strong></li>
    <li>🏛️ <strong>Double-Height Grand Lobby for Guests</strong></li>
    <li>🛗 <strong>4 High-Speed Air-Conditioned Elevators per Tower</strong></li>
    <li>🌬️ <strong>Air-Conditioned Lift Lobbies on All Floors</strong></li>
    <li>🏡 <strong>Imported Marble, Engineered Wood Flooring & VRV Air-Conditioning</strong></li>
    <li>🍽️ <strong>European Branded Fully-Fitted Modular Kitchen</strong></li>
</ul>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-3">
                <div style="overflow: hidden; border-radius: 10px; height: 250px;">
                    <img src="images/extra/M3M-Mansion-Gurgaon-image--.webp" class="img-fluid rounded shadow" alt="Gallery Image 1" loading="lazy"
            ...
            <div class="col-md-3">
                <div style="overflow: hidden; border-radius: 10px; height: 250px;">
                    <img src="images/extra/M3M-Mansion-Gurgaon-image-2-.webp" class="img-fluid rounded shadow" alt="Gallery Image 3" 
            ...
            <div class="col-md-3">
                <div style="overflow: hidden; border-radius: 10px; height: 250px;">
                    <img src="images/extra/M3M-Mansion-Gurgaon-image-1-.webp" class="img-fluid rounded shadow" alt="Gallery Image 4" loading="lazy" 
                        style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.3s ease-in-out;"
                        onmouseover="this.style.transform='scale(1.05)'" 
                        onmouseout="this.style.transform='scale(1)'">
                </div>
            ...
            <div class="col-md-3">
                <div style="overflow: hidden; border-radius: 10px; height: 250px;">
                    <img src="images/extra/M3M-Mansion-Gurgaon-image-7-.webp" class="img-fluid rounded shadow" alt="Gallery Image 6" loading="lazy"
                        style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.3s ease-in-out;"
                        onmouseover="this.style.transform='scale(1.05)'" 
                        onmouseout="this.style.transform='scale(1)'">
                </div>
...
<section id="floorplan" style="padding: 60px 0; background-color:#bab777; text-align: center;">
    <div class="container" style="max-width: 1100px; margin: auto; padding: 0 20px;"><br>
        ...
        <div style="display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 40px;">
                ...
                <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="border: 2px solid #c79c3d; padding: 12px;">2077 SQ.FT</td>
                            <td style="border: 2px solid #c79c3d; padding: 12px;">On Request</td>
                        </tr>
                        <tr>
                            <td style="border: 2px solid #c79c3d; padding: 12px;">4 BHK + S </td>
                            <td style="border: 2px solid #c79c3d; padding: 12px;">2700 SQ.FT</td>
                            <td style="border: 2px solid #c79c3d; padding: 12px;">On Request</td>
                        </tr>
                        </tbody>
            ...
            <div style="width: 100%; max-width: 500px; flex: 1; text-align: center;">
                <img src="images/extra/tower-cdefg.jpg" alt="Floor Plan"data-bs-toggle="modal" data-bs-target="#contactModal"  
...
<section id="highlights" style="background-color:#bab777; padding: 50px 0;">
    <div class="container">
        <div class="row align-items-center justify-content-center"> 
            ...
            <div class="col-md-6 text-center">
                <img src="images/extra/yoga-zone.jpg" alt="Overview Image" class="img-fluid" 
...
<ul style="list-style: none; padding-left: 0;">
    <li style="margin-bottom: 10px; font-size: 16px;">⛳ <strong>18-Hole Golf Course within the Property</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">✨ <strong>100+ Amenities & Premium Lifestyle Services</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🚗 <strong>Stilt-Level Dedicated Parking Space for Every Homeowner</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🏢 <strong>Massive 1,00,000 sq. ft. Clubhouse on Dwarka Expressway</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🌿 <strong>Surrounded by Lush Green & Open Landscapes</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">💧 <strong>Outdoor Pool with Pristine Water Bodies</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🏌️ <strong>Golf-Themed Landscaped Surroundings</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">📚 <strong>All Apartments Include a Study Room and Help Room</strong></li>
</ul>
...
<ul style="list-style: none; padding-left: 0; font-size: 15px;">
    <li style="margin-bottom: 10px;">✈️ <strong>Near IGI Airport and Aerocity</strong></li>
    <li style="margin-bottom: 10px;">🏛️ <strong>Close to Yashobhoomi Convention Centre</strong></li>
    <li style="margin-bottom: 10px;">🌍 <strong>Few Minutes Drive to Diplomatic Enclave II</strong></li>
    <li style="margin-bottom: 10px;">🛣️ <strong>Located Bang on Dwarka Expressway</strong></li>
    <li style="margin-bottom: 10px;">🏢 <strong>Direct Connectivity to DLF Cyber Hub and Udyog Vihar</strong></li>
    <li style="margin-bottom: 10px;">🛣️ <strong>Well-connected to NH-8, Golf Course Road, Golf Course Extension & Peripheral Road</strong></li>
    <li style="margin-bottom: 10px;">🎢 <strong>Approx. 5–10 Minutes from Bharat Vandana Park (220 Acres)</strong></li>
    <li style="margin-bottom: 10px;">🏟️ <strong>Near International Sports Complex (62 Acres)</strong></li>
    <li style="margin-bottom: 10px;">🏌️ <strong>Close to Delhi Golf Club – II (India’s Longest Golf Course)</strong></li>
</ul>
        ...
        <!-- Right Side - Image -->
        <div style="flex: 1 1 400px; max-width: 500px;">
            <img src="images/extra/M3M-Mansion-Gurgaon-Location-Map.webp" alt="Location Map" data-bs-toggle="modal" data-bs-target="#contactModal"  
