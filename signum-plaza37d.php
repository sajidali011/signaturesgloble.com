...
<section id="home" class="bg-light">
    <div class="position-relative">
        <!-- Main Image -->
        <img src="images/commercial/4.png" class="w-100 vh-100" alt="Signature Global City">

        <!-- Logo (Left Side Thoda Niche) -->
        <div class="position-absolute bottom-0 start-0 mb-3 ms-3">
            <img src="images/commercial/SIGNUM-PLAZA-37D.png" width="150" alt="SG Logo">
        </div>
    </div>
    ...
    HRERA Number - RC/REP/HARERA/GGM/462/194/2021/30    </div>

    <!-- Welcome Section -->
    <div class="container-fluid text-center mt-0 bg-dark text-white p-5">
        <h5 class="fw-bold text-white">WELCOME TO</h5>
        <h1 class="fw-bold text-white">Signum Plaza 37D (Commercial of Signature Global City 37D )</h1>
        <p class="mt-3">  
    <strong>Signature Global Signum Plaza 37D</strong> is a premium commercial hub within  
    <strong>Signature Global City 37D</strong>, Sector 37D, Gurugram. Strategically located, it serves an affluent customer base with easy access to  
    <strong>Cyber City, Golf Course, Sohna, and Manesar</strong>. Well-connected to  
    <strong>Hero Honda Chowk and Dwarka Expressway</strong>, it offers <strong>modern retail spaces</strong>,  
    making it a top choice for businesses and shoppers.  
</p>


        <p class="fw-bold">RETAIL HUB AT SIGNATURE GLOBAL CITY 37D, GURUGRAM</p>
    </div>
</section>
...
<div class="container mt-5">
    <div class="row g-3 align-items-stretch">
        ...
        <div class="col-md-6 d-flex">
            <img src="images/commercial/Location-map5.jpg" class="img-fluid w-100 rounded h-100" alt="Location Map" 
                style="object-fit: cover;height: 500px; min-height: 500px; cursor: pointer;"
                onclick="openModal('images/commercial/Location-map5.jpg')">
        </div>
    ...
    <li>Moreover, there is easy connectivity to the city's employment hubs through Pataudi Road, NH8, Dwarka Expressway and Southern Peripheral Road.</li>
    <li>Another point about this sector which makes it an ideal residential destination is strong social infrastructure in the neighbourhood.</li>
    <li>The sector has witnessed development of several residential projects in the vicinity.</li>
                ...
                <div id="location_advantages1" class="tab-content mt-3 d-none">
                    ...
                    <ul>
    <li>Residential projects in these places are ideal for those who choose to surround themselves by abundant greenery with the soothing sound of nature.</li>
    <li>Well established network of Schools, Hospitals, Shopping Malls, Retail Markets and Five Star Hotels.</li>
    <li>The sector has witnessed good returns in terms of rent because it has an ideal location for the people who are always on the move and work in the private and retail sectors.</li>
    <li>The city has a great connectivity with the international airport via Dwarka Expressway.</li>
</ul>
    ...
    <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/commercial/16.jpg" class="d-block w-100" 
                     style="height: 500px; max-height: 90vh; object-fit: cover;" 
                     alt="Gallery Image 1">
            </div>
            <div class="carousel-item">
                <img src="images/commercial/29.jpg" class="d-block w-100" 
                     style="height: 500px; max-height: 90vh; object-fit: cover;" 
                     alt="Gallery Image 2">
            </div>
            <div class="carousel-item">
                <img src="images/commercial/31.jpg" class="d-block w-100" 
                     style="height: 500px; max-height: 90vh; object-fit: cover;" 
                     alt="Gallery Image 2">
            </div>
            <div class="carousel-item">
                <img src="images/commercial/4.png" class="d-block w-100" 
                     style="height: 500px; max-height: 90vh; object-fit: cover;" 
                     alt="Gallery Image 2">
            </div>
            <div class="carousel-item ">
                <img src="images/commercial/Elevation1.jpg" class="d-block w-100" 
                     style="height: 500px; max-height: 90vh; object-fit: cover;" 
                     alt="Gallery Image 2">
            </div>
            <div class="carousel-item">
                <img src="images/commercial/Elevation2.jpg" class="d-block w-100" 
                     style="height: 500px; max-height: 90vh; object-fit: cover;" 
                     alt="Gallery Image 2">
            </div>
...
<div style="background-color: #6b8c8a; color: white; padding: 20px;margin-bottom: -50px;">
    <div class="container">
        <p style="font-weight: bold; margin-bottom: 5px;">Signatureglobal Developers Pvt. Ltd. | CIN - U70109DL2012PTC241901
        </p>
