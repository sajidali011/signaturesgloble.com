...
<section id="home" class="bg-light">
    <div class="position-relative">
        <!-- Main Image -->
        <img src="images/commercial/Signum Plaza 81-min.webp" class="w-100 vh-100" alt="Signature Global City">

        <!-- Logo (Left Side Thoda Niche) -->
        <div class="position-absolute bottom-0 start-0 mb-3 ms-3">
            <img src="images/commercial/SIGNUM--PLAZA-81.png" width="150" alt="SG Logo">
        </div>
    </div>
    ...
    RERA REGISTRATION NO.: RC/REP/HARERA/GGM/478/210/2021/46
    </div>

    <!-- Welcome Section -->
    <div class="container-fluid text-center mt-0 bg-dark text-white p-5">
        <h5 class="fw-bold text-white">WELCOME TO</h5>
        <h1 class="fw-bold text-white">Signum Plaza 81 (Commercial of Signature Global City 81)</h1>
        <p class="mt-3">  
    A seamless blend of uniquely designed retail spaces nestled within the Signature Global City 81 residential complex in Sector 81, Gurugram, <strong>Signature Global Signum Plaza 81</strong> is a prime commercial property catering to an upscale clientele. Boasting a <strong>strategic location</strong> and <strong>stunning architecture</strong>, this retail hub is designed to attract a diverse range of visitors—from essential shoppers to leisure seekers—making it a perfect destination for all.  
</p>

        <p class="fw-bold">COMMERCIAL PROPERTY IN SECTOR 81, GURUGRAM</p>
    </div>
</section>
...
<div style="display: flex; justify-content: center; align-items: center;">
    <div style="position: relative; width: 80%; max-width: 800px; padding-bottom: 45%; height: 0; overflow: hidden;">
        <iframe style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" 
            src="https://www.youtube.com/embed/iTfpeAEqlWQ?si=kvB9ianVchrj8A39" 
...
<div class="container mt-5">
    ...
    <li>Well-established network of Schools, Hospitals, Shopping Malls, Retail Markets, and Five Star Hotels in the vicinity.</li>
    <li>The city is very close to the international airport via NH-8 and Dwarka Expressway.</li>
    <li>The sector is well connected with the network of the proposed metro line.</li>
</ul>
    ...
    <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/commercial/21.jpg" class="d-block w-100" 
                     style="height: 500px; max-height: 90vh; object-fit: cover;" 
                     alt="Gallery Image 1">
            </div>
            <div class="carousel-item">
                <img src="images/commercial/3.jpg" class="d-block w-100" 
                     style="height: 500px; max-height: 90vh; object-fit: cover;" 
                     alt="Gallery Image 2">
            </div>
            <div class="carousel-item">
                <img src="images/commercial/Signum Plaza 81-min.webp" class="d-block w-100" 
                     style="height: 500px; max-height: 90vh; object-fit: cover;" 
                     alt="Gallery Image 2">
            </div>
...
<div style="background-color: #6b8c8a; color: white; padding: 20px;margin-bottom: -50px;">
    <div class="container">
        <p style="font-weight: bold; margin-bottom: 5px;">Sternal Buildcon Pvt Ltd | CIN : U70109DL2009PTC195052
        </p>
